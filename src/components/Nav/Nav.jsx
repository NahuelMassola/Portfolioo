...
import download from './assets/CV - Nahuel Dellacecca Massola.pdf';
    ...
    >
        ...
        <div className={s.icons}>
            ...
            <div className={s.contacts}>
                <motion.a href="https://github.com/NahuelMassola" target='_blank' rel="noreferrer"
                    initial={{opacity: 0, y:-100}}
                    animate={{opacity:1, y:0}}
                    transition={{duration: 0.3, delay: 2.3}}
                ><img src={github} alt="github"/></motion.a>

                <motion.a href="https://www.linkedin.com/in/nahuel-alejandro-dellacecca-massola/" target='_blank' rel="noreferrer"
                    initial={{opacity: 0, y:-100}}
                    animate={{opacity:1, y:0}}
